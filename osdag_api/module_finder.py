from osdag_api.modules import beam_beam_end_plate_connection, fin_plate_connection,end_plate_connection,cleat_angle_connection,seated_angle_connection,cover_plate_bolted_connection, cover_plate_welded_connection, beam_column_end_plate, struts_in_trusses
...
module_dict : Dict[str, ModuleApiType] = {
    ...
    "Struts In Trusses": struts_in_trusses,
} 
