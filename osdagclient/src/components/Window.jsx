              ...
              {subDesignTypes.data.map((item) => {
                return (
                  <button
                    key={item.id}
                    className={
                      subActiveTab === item.id
                        ? "tab-btn tabs active-subtabs"
                        : "tab-btn tabs"
                    }
                    onClick={() => {
                      ...
                      <div className="conn-grid-container">
                        <div
                          className={`conn-grid-item ${
                            selectedItemBack === item.name ? "selected" : ""
                          }`}
                        >
              ...
              <center>
                <div className="">
                  <button
                    ...
                    onClick={() => {
                      if (
                        selectedDesign === "fin_plate" ||
                        selectedDesign === "end_plate" ||
                        selectedDesign === "cleat_angle" ||
                        selectedDesign === "seated_angle"
                      ) {
