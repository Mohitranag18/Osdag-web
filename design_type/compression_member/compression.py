...
from design_report.reportGenerator_latex import *
...
from utils.common.component import Angle
...
class Compression(Member):
    ...
    def __init__(self):
        ...
        self.result_designation = "30 x 30 x 3"  # or some default value
        self.result_UR = 0.957  # or some default value
        self.result_section_class = "Semi-Compact"  # or some default value
        self.result_effective_area = 176.0  # or some default value
        self.result_eff_len = 390.0  # or some default value
        self.result_eff_sr = 66.1  # or some default value
        self.result_lambda_vv = "NA"  # or some default value
        self.result_lambda_psi = "NA"  # or some default value
        self.result_ebs = 451.78  # or some default value
        self.result_bc = c  # or some default value
        self.result_IF = 0.49  # or some default value
        self.result_srf = 0.65  # or some default value
        self.result_nd_esr = 0.81  # or some default value
        self.result_fcd = 178.04  # or some default value
        self.result_capacity = 31.33  # or some default value
    ...
    def set_input_values(self, design_dictionary):
            ...
            print("-inside the set_input_values, file: compression.py")
            ...
            # try :
            self.in_plane = float(KEY_Buckling_In_plane)
            self.out_plane = float(KEY_Buckling_Out_plane)
            print("-till line 455, file: compression.py")

            if KEY_BOLT_Number not in design_dictionary:
                self.bolts = 0.0
            else:
                self.bolts = float(KEY_BOLT_Number)

            if KEY_PLATETHK not in design_dictionary:
                self.plate_thickness = 0.0
            else:
                # Gusset plate details
                self.plate_thickness = float(KEY_PLATETHK)
            ...
            # safety factors
            print(IS800_2007.cl_5_4_1_Table_5)
            self.gamma_m0 = IS800_2007.cl_5_4_1_Table_5["gamma_m0"]["yielding"]
            print("-till line 531, file: compression.py")
            ...
            print("-till line 539, file: compression.py")
            ...
            print(f"self.K : {self.K}")
            print("-till line 557, file: compression.py")
        ...
        for section in self.sec_list:
            ...
            if (self.sec_profile in VALUES_SEC_PROFILE_Compression_Strut[:3]):  # Angles or Back to Back or 'Star Angle'
                ...
                if self.section_property.type == 'Rolled':
                    ...
                    print("line 640, section property", self.section_property)
            ...
            #     #     local_flag = False
            #     #     break
            # print(f"K: {self.K}, L: {self.length}, r: {min_radius_gyration}")
            print(f"section property: {self.section_property}")
            ...
            print(f"min_radius_gyration {min_radius_gyration}, slenderness {slenderness}")
            print("line 736")
    ...
    def section_classification_subchecks(self, section):
        if self.sec_profile in [Profile_name_1, Profile_name_2, Profile_name_3]:
            ...
            # self.section_property = Angle(designation=section, material_grade=self.material)
            pass  # Add real implementation

        elif self.sec_profile == VALUES_SEC_PROFILE_Compression_Strut[3]:
            print("section_classification_subchecks error")
            # self.section_property = Channel(designation=section, material_grade=self.material)

        else:
            logger.warning("The section should be either Angle or Back to Back Angle.")
